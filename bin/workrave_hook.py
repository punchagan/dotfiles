...
class WorkraveDBus:
    ...
    def on_break_idle(self, breakid):
        ...
        if self.workrave.GetTimerIdle(breakid) >= autoreset:
            ...
            print 'Break %s postponed' % breakid

if __name__ == '__main__':
    CMD = ['emacsclient', '-cne', '-F', '((title . "What are you doing?") (user-position . t) (left . (+ 550)) (top . (+ 400)) (width . 120) (height . 40))', '(progn (org-journal-new-entry nil) (spacemacs/toggle-maximize-buffer) (recenter 0) (raise-frame) (x-focus-frame (selected-frame)))']
    d = WorkraveDBus(CMD)
